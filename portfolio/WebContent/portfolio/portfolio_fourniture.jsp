...
<body>
	...
	<div class="portfolio_content">
		<section id="all_pf">
			<div class="pf_tap">
				<ul>
					...
					<li><a href="http://localhost:9000/portfolio/portfolio/portfolio_fourniture.jsp" style="background-color:#f4e7d3; color:white;">FOURNITURE</a></li>
		...
		<section id="my_work">
			...
			<article>
				<div class="work_img">
					<img src="http://localhost:9000/portfolio/images/work6_2.jpg">
